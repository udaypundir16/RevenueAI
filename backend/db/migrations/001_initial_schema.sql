...
-- Description: Core schema for Revenue Recovery AI platform (Supabase / PostgreSQL)
-- Tables:
--   1. customers
--   2. transactions
--   3. retry_attempts
...
-- Enable RLS on all revenue recovery tables
-- ----------------------------------------------------------------------------
...
-- Allow service role full access (default policy for backend microservice operations)
DO $$
BEGIN
    IF NOT EXISTS (
